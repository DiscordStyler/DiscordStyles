 ...
 */
export const getConfig = async (themeName?: string) => {
	const find = themeName ? path.join(process.cwd(), 'themes', themeName, 'theme.config.js') : path.join(process.cwd(), 'theme', 'theme.config.js') ;
